...
Teck's history is deeply intertwined with Canada's industrial development:

| Era | Milestone |
|-----|-----------|
| **1913** | Founded as Teck-Hughes Gold Mines in Kirkland Lake, Ontario |
| **1906** | Cominco (Consolidated Mining and Smelting) established to operate Sullivan Mine |
| **1960s** | Norman Keevil acquires Teck-Hughes; merger with Cominco begins modern era |
...
| **Zinc** | Red Dog Mine (Alaska), Trail Operations (BC) | ~25% of EBITDA |
| **Other** | Refined metals, molybdenum, silver, gold | ~5% of EBITDA |

### 1.3 Management Team

| Position | Name | Background | Key Achievements |
|----------|------|------------|------------------|
| **CEO** | Jonathan Price | Former CFO, joined 2020 | Led coal divestiture, QB2 ramp-up, Anglo merger negotiations |
| **Deputy CEO (Post-Merger)** | Jonathan Price | - | Positioned to be Deputy CEO of Anglo Teck |
| **COO** | Shehzad Bharmal | EVP Operations | Oversaw QB2 commissioning |
| **CFO** | John Heasley | - | Will serve as CFO of Anglo Teck post-merger |
| **Chair** | Sheila Murray | Former Deloitte partner | Leading governance transformation |

### 1.4 Corporate Governance Evolution

The Keevil family's dual-class share structure—long a governance overhang—has been addressed through the Anglo merger structure. The family has committed to voting in favor of the transaction, providing irrevocable support for approximately 80% of Class A shares.
...
Teck's balance sheet is among the strongest in the sector:
...
| Metric | TECK | Sector Avg | FCX (Peer) | BHP (Peer) |
|--------|------|------------|------------|------------|
| **P/E (TTM)** | 23.7x | 18.5x | 19.2x | 12.4x |
| **Forward P/E** | 14.99x | 16.2x | 15.1x | 11.8x |
| **EV/EBITDA** | 9.09x | 7.5x | 8.2x | 6.1x |
| **Price/Book** | 1.31x | 1.8x | 3.4x | 2.1x |
| **EV/Revenue** | 3.50x | 2.8x | 3.1x | 2.4x |

**Assessment:** TECK trades at a premium to sector on TTM metrics but appears attractive on forward basis as QB2 reaches steady state.
...
**QB2 Production Guidance (Updated October 2025):**

| Year | Previous Guidance | Revised Guidance | Key Driver |
|------|-------------------|------------------|------------|
| **2025** | 210-230 kt | 170-190 kt | TMF drainage issues |
| **2026** | 280-310 kt | 200-235 kt | Continued TMF work |
| **2027** | 280-310 kt | 240-275 kt | TMF steady-state |
| **2028** | 270-300 kt | 220-255 kt | Lower grade zone |

**Critical Issue:** Tailings Management Facility (TMF) sand drainage challenges have delayed the ramp-up. Ultra-fines removal initiatives and sand placement technique refinements are underway.

**Recovery Potential:** Design recoveries of 86-92% remain achievable vs. current 82-85%.

### 4.2 Anglo American Merger Synergies

The merger creates exceptional value through:
...
| Mine | Location | Ownership | 2024 Production |
|------|----------|-----------|-----------------|
| Collahuasi | Chile | 44% | 245.8 kt |
| Quebrada Blanca | Chile | 60% | 207.8 kt |
| Quellaveco | Peru | 60% | 306.3 kt |
| Los Bronces | Chile | 50.1% | 172.4 kt |
| Highland Valley Copper | Canada | 100% | 102.4 kt |
| Antamina | Peru | 22.5% | 96.1 kt |

**Total Combined:** ~1.2M tonnes annually, growing to ~1.35M tonnes by 2027

### 4.3 Copper Market Dynamics

**Demand Drivers:**

| Driver | Impact | Timeline |
|--------|--------|----------|
| **Electric Vehicles** | 4x copper vs. ICE vehicles | 2025-2035 |
| **Renewable Energy** | 5x copper for wind/solar | Ongoing |
| **AI Data Centers** | New demand vector | 2025+ |
...
| Project | Location | Status | Potential |
|---------|----------|--------|-----------|
| **Zafranal** | Peru | PEA complete | 200+ kt copper |
| **San Nicolás** | Mexico | Early stage | Copper-zinc |
| **NuevaUnión** | Chile | JV with Goldcorp | Large copper-gold |
| **Galore Creek** | BC, Canada | 50% JV | Copper-gold |
| **Schaft Creek** | BC, Canada | Exploration | Copper-gold |
...
|------|----------|------------|
| **QB2 TMF Issues** | HIGH | Technical work ongoing; expect resolution by 2027 |
| **Chile Geopolitical** | MEDIUM | Stable jurisdiction; royalty changes manageable |
| **Grade Variability** | MEDIUM | HVC Lornex fault being mined through Q1 2026 |
| **Recovery Rates** | MEDIUM | Geo-metallurgical work to achieve design targets |

### 5.2 Financial Risks

| Risk | Assessment |
|------|------------|
| **Commodity Price Volatility** | High correlation to copper; use options/hedging |
| **Currency Exposure** | CAD, USD, Chilean Peso; natural hedges in place |
| **Interest Rates** | Limited debt; investment grade rating |
| **Tax Changes** | Chile royalty increases factored into guidance |

### 5.3 Macro/Sector Risks

| Risk | Probability | Impact |
|------|-------------|--------|
| **China Demand Slowdown** | Medium | China ~50% of copper demand; diversification underway |
| **Global Recession** | Medium | Would depress copper prices 20-30% |
| **Substitution Risk** | Low | Aluminum limited substitution; copper essential |
| **ESG/Climate Policy** | Low | Benefits from green energy transition |

### 5.4 Merger-Specific Risks
...
| Category | Risk Level | Monitoring Priority |
|----------|------------|---------------------|
| QB2 Operational | HIGH | Weekly production reports |
| Copper Prices | HIGH | Monthly demand/supply analysis |
| Merger Execution | MEDIUM | Regulatory announcements |
...
|--------|-------|-----------------|
| BlackRock | ~8% | Increased post-coal sale |
| Vanguard | ~6% | Core holding |
...
| Metric | Value | Interpretation |
|--------|-------|----------------|
| **Short Interest** | ~2.5% | Low; limited bearish positioning |
...
|----------|-----------|------------|
| **Twitter/X** | Bullish | Copper supercycle, Anglo merger |
| **Reddit** | Neutral/Positive | QB2 execution concerns, long-term bullish |
| **Seeking Alpha** | Positive | ESG improvement, cash flow growth |
| **Institutional** | Positive | ESG funds adding post-coal sale |
...
|-------|----------------|
| **Copper deficit narrative** | +Structural demand support |
| **AI data center boom** | +New copper demand vector |
| **China stimulus measures** | +Potential demand boost |
...
|------|-------|------------------|
| **Apr 23, 2026** | Q4 2025 Earnings | Operational update |
| **Q2 2026** | Anglo merger regulatory approvals | Key milestone |
| **Mid-2026** | Anglo Teck merger close | Transformational |
...
|--------|---------------|
| **QB2 / Quebrada Blanca 2** | Teck's giant new copper mine in Chile—its most important growth project |
| **Tailings Management Facility (TMF)** | A dam that holds leftover rock/waste from mining; currently causing production delays |
| **Merger of Equals** | Two companies combining as partners, not one buying the other |
| **Copper Equivalent** | Converting all metals to copper-value for comparison |
| **Net Cash Position** | More cash in the bank than debt owed—very strong financial position |
| **Synergies** | Cost savings from combining two companies |
...
**Why it matters:** As the world goes electric, copper demand will soar. Teck positioned itself perfectly by building QB2 and is now merging with Anglo American to become one of the world's biggest copper producers.
...
- And a bigger developer wants to merge with you (Anglo American)
- But there's a plumbing issue to fix first (TMF problems)

**The bet:** The plumbing gets fixed, the neighborhood booms, and your property value rises significantly.
...
|-------|----------|---------|-----------|--------|
| Quebrada Blanca | Chile | Copper | 60% | Ramping up |
| Highland Valley Copper | BC, Canada | Copper | 100% | Operating |
| Antamina | Peru | Copper/Zinc | 22.5% | Operating |
| Carmen de Andacollo | Chile | Copper | 90% | Operating |
...
- FinancialContent Research Feature (February 2026)
- Al Jazeera Mining Coverage
...
This report is for informational purposes only and does not constitute investment advice. The author is not a licensed financial advisor. Past performance is not indicative of future results. Commodity investments carry significant risk, including potential loss of principal. Readers should conduct their own due diligence and consult with qualified financial advisors before making investment decisions.

**Data as of April 3, 2026.** Market conditions and company circumstances may change rapidly.

...
**Recommendation:** HOLD with caution - strategic position sizing is critical. Consider profit-taking or hedging before earnings given volatility risk.
...
| Source | Date | Status |
|--------|------|--------|
| TipRanks | May 13, 2026 | Q1 2026 (Confirmed) |
| Investing.com | Feb 26, 2026 | (Already passed) |
| Simply Wall St | March 16, 2026 | Today ("now-past") |
| Company IR | *Unclear* | Q4 2025/FY2025 TBD |
...
**T1 Energy** is building an integrated U.S. solar supply chain through two major facilities:

#### G1_Dallas (Operational)
- **Location:** Wilmer, Texas (15 miles south of Dallas)
- **Capacity:** 5 GW annual module production
- **Status:** Operational, ramping to 4.5 GW run rate by Q4 2025
- **Workforce:** ~1,200 employees
- **Technology:** TOPCon solar modules
- **Supply Chain:** Hemlock Semiconductor (polysilicon), Corning (wafers), Nextpower (steel frames)
...
- Execution risk on G2_Austin construction
...
**February 17, 2026 - Treasury FEOC Guidance** ⬆️
- Treasury guidance on Foreign Entity of Concern (FEOC) rules
- Confirmed T1's eligibility for Section 45X tax credits
- Stock rallied 13.7% on the news

**December 30, 2025 - First 45X Credit Sale** ⬆️
- Executed first sale of Section 45X tax credits
...
- Phase 2 potential: +3.2GW
- Total site capacity: Up to 8GW across three phases

### Management Changes

**Russell Gold** joined as EVP Strategic Communications (May 2025)
- Former Wall Street Journal energy reporter
- Strong industry credibility

---

## 4. SOCIAL MEDIA & SUBSTACK INTELLIGENCE
...
## 7. POSITION STRATEGIES FOR THOMAS
...
**Pros:** Derisked, still participate in upside  
**Cons:** Miss full upside if stock rockets
...
**Pros:** Maximum upside capture  
**Cons:** Full downside risk
...
**Pros:** Disciplined approach  
**Cons:** May be stopped out on volatility
...
**Pros:** Defined maximum loss  
**Cons:** Option cost reduces returns
...
|------|----------|----------|
| **Balance Sheet/Liquidity** | 🔴 HIGH | 45X credit monetization, potential asset sales |
| **Policy Changes (IRA repeal)** | 🔴 HIGH | Trump admin has signaled support for domestic manufacturing |
| **Execution Risk (G2)** | 🟡 MEDIUM | Experienced management, construction underway |
| **Competition** | 🟡 MEDIUM | Differentiated integrated supply chain |
| **Customer Concentration** | 🟡 MEDIUM | Expanding customer base, multiple offtake discussions |

### Binary Events to Watch
1. **Q4/FY2025 Earnings Release** - Within next 60 days
2. **G2_Austin Construction Milestones** - Throughout 2026
3. **Treasury FEOC Final Rules** - Expected mid-2026
4. **First G2 Cells Production** - Q4 2026
...
**For Thomas's 60-share position:**

Given the **conflicting information about actual cost basis**, first verify:
1. Actual current unrealized P&L
2. Position sizing relative to total portfolio
3. Risk tolerance for small-cap volatility
...
- T1 Energy IR: https://ir.t1energy.com
- Q3 2025 10-Q Filing (Nov 14, 2025)
- G2_Austin Construction Press Release (Dec 17, 2025)
- Treasury FEOC Guidance Press Release (Feb 17, 2026)
...
*Disclaimer: This analysis is for informational purposes only and does not constitute investment advice. Solar manufacturing stocks carry significant risk. Consult a financial advisor before making investment decisions.*

**Report Generated:** March 16, 2026  
**Next Update:** Post-Earnings

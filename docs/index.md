...
94 tickers across 9 investment themes. Each ticker gets a concise summary on its thematic page and a full deep-dive page. All data is also available as structured JSON for AI agents and as an MCP server for Claude.
...
```
GET /api/tickers.json          → master index of all 94 tickers
